...
controller=("controller" "${gerenciamento}.11" "${ipAcessoVM}.111") #("host" "ip_host" "ip_acesso_vm")
compute1=("compute1" "${gerenciamento}.21" "${ipAcessoVM}.111")
compute2=("compute2" "${gerenciamento}.22" "${ipAcessoVM}.122")
compute3=("compute3" "${gerenciamento}.23" "${ipAcessoVM}.123")
storage1=("storage1" "${gerenciamento}.31" "${ipAcessoVM}.131")
storage2=("storage2" "${gerenciamento}.32" "${ipAcessoVM}.132")
storage3=("storage3" "${gerenciamento}.33" "${ipAcessoVM}.133")
senha="admin"