...
# Definir o nome do host como 'compute3'
echo "Definindo o hostname como '${compute3[0]}'..."
sudo hostnamectl set-hostname ${compute3[0]}
...
server_proxyclient_address = ${compute3[1]}
