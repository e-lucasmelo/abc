...
echo "Definindo o hostname como 'controller'..."
...
openstack user create --domain default --password "admin" myuser
...
GRANT ALL PRIVILEGES ON cinder.* TO 'cinder'@'localhost' IDENTIFIED BY 'admin';
GRANT ALL PRIVILEGES ON cinder.* TO 'cinder'@'%' IDENTIFIED BY 'admin';
EOF
...
openstack user create --domain default --password "admin" cinder
